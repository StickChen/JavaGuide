...
通过 [https://resume.github.io/](https://resume.github.io/) 这个网站你可以一键生成一个在线的 Github 简介。

当时我参加的校招的时候，个人信息那里就放了一个在线的 Github 简介。我觉得这样会让思考官感觉你是一个内行，会提高一些印象分。

但是，如果你的 Github 没有什么项目的话还是不要放在简介里面了。生成后的效果如下图所示。

![Github简介](https://guide-blog-images.oss-cn-shenzhen.aliyuncs.com/2020-11/image-20201108192205620.png)
